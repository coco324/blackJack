...
import { CreateUser,Login,Logout,CheckAuth,GetUserStats, GetLeaderboard ,GetAllUsers, GetExamData } from "./controller/user.controller.js";
...
app.get("/GetExamData", GetExamData);
