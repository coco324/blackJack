  ...
  <div class="min-h-screen bg-cover bg-center flex items-center justify-center" :style="{ backgroundImage: `url(${backgroundImage})` }">
    ...
    <div class="size-200 flex flex-col items-center">
      ...
      <div class="border-2 border-[#806210] rounded-2xl p-6 bg-[#083042] grid grid-cols-2 gap-4 mb-8 m-4 w-full ">
        ...
        <button class="p-2 border border-gray-600 rounded-lg text-white h-15 hover:bg-gray-700 col-span-1 active:bg-gray-800" @click="router.push('/rules')">Règle du jeu</button>
        <button class="p-2 border border-gray-600 rounded-lg text-white h-15 hover:bg-gray-700 col-span-1 active:bg-gray-800" @click="router.push('/leaderboard')">Classement</button>
      </div>
